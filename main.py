...
from data   import Room_data, Air_data, Energy_data
from data_L import CIFAR_10_data, MNIST_data, EMNIST_data, data_shuffle
from model  import OFL_Model

K = 1000
D = 4353 # MNIST 34826 / CIFAR_10 60362 / EMNIST 60442 / Air,En 4353 / Room 5380
P = 0.10
...
data, x_train, y_train, input_size = Energy_data()                                                # MNIST_data() #Room_data()
...
initial_weights = Model_list[0].pre_train(x_train[0:2], y_train[0:2], 1)                    # Pre-train data length
